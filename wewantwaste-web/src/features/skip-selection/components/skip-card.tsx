...
const SkipCard = ({
  ...
  return (
    <Card
      className={cn(
        "shadow-md hover:shadow-lg duration-300 rounded-lg px-2 py-4 md:shadow-2xl cursor-pointer transition-all border border-medium-gray-200",
        isSelected
          ? "border-2 border-apple-green-500"
          : "hover:border-medium-gray-300"
      )}
    >
      <CardImage
          ...
          <span
            className={`text-xs font-medium px-2 py-1 rounded-full ${
              skip.allowed_on_road
                ...
                : "bg-warm-orange-100 text-warm-orange-800"
            }`}
          >
      ...
      <CardAction className="px-4 py-3 border-t border-gray-100">
        ...
        <Button
          className="w-32 text-foreground bg-apple-green-500 hover:bg-apple-green-600"
          onClick={onClick}
          variant="default"
        >
